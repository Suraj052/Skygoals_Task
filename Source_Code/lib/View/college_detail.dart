      ...
      child: Scaffold(
        ...
        _scrollPosition == 0?
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      child: CircleAvatar(
                          ...
                          child: Icon(Icons.arrow_back_rounded,color: Color(0xFF0C55EC),size: 25)
                      ),
                    ),
                    CircleAvatar(
                        backgroundColor: Colors.white,
            ...
            : AppBar(
                ...
                title: Padding(
                  padding: const EdgeInsets.fromLTRB(5,0,5,0),
                  child: Text("GHJK Engineering college",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 20.0)),
                ),
              ),
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("GHJK Engineering college",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 20.0)),
                                SizedBox(height: 10),
                                Text(maxLines: 5,"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Felis consectetur nulla pharetra praesent hendrerit vulputate viverra. Pellentesque aliquam tempus faucibus est.",style:
                                  TextStyle(wordSpacing:3,color: Color(0xFF8E8E8E),fontFamily: 'Lato',fontSize: 12.0)),
                              ],
                            ),
                          ),
                          Container(
                            ...
                            child: Column(
                                  ...
                                  children: [
                                    Text("4.3",style: TextStyle(fontFamily: 'Lato',fontSize: 14,fontWeight:FontWeight.w800,color: Color(0xFFffffff))),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TabBar(
                                  ...
                                  labelStyle: TextStyle(fontSize: 11,fontFamily: 'Lato',fontWeight: FontWeight.w600),
                                  labelColor: Colors.black,
                                  unselectedLabelColor: Colors.black,
                                  indicatorColor: Color(0xFF0E3C6E),
                                  indicator: UnderlineTabIndicator(
                                    borderSide: BorderSide(width: 5.0,color: Color(0xFF0E3C6E)),
                                  ),
                                  tabs: [
        ...
        bottomNavigationBar: Container(
          margin: EdgeInsets.fromLTRB(10, 0, 10, 2),
            ...
            child: Center(child: Text("Apply Now",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 20.0))),
          ),
        ),
    );
  }
      ...
      child: Column(
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Description",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 16.0)),
              SizedBox(height: 12),
              Text(maxLines: 10,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque accumsan, scelerisque eget lectus ullamcorper a placerat. Porta cras at pretium varius purus cursus. Morbi justo commodo habitant morbi quis pharetra posuere mauris. Morbi sit risus, diam amet volutpat quis. Nisl pellentesque nec facilisis ultrices.",style:
                  TextStyle(wordSpacing:2,color: Color(0xFF969797),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 13.0)),
            ],
          ),
          SizedBox(height: 30),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Location",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 16.0)),
              SizedBox(height: 15),
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.cover,
                        image: NetworkImage("https://www.figma.com/file/7XaIws0wlTqPMnQDBuj97h/image/3e41aa0dfbb3b39cc5d563bd651d82a319a7a927?fuid=1056804369553678142")
                    )
                ),
              )
            ],
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text("+12",style: TextStyle(color: Color(0xFF0E3C6E),fontWeight:FontWeight.w800,fontFamily: 'Lato',fontSize: 14))),
                  )
                ],
              )
            ],
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Arun Sai",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 16.0)),
                  SizedBox(height: 15),
                  Text(maxLines: 10,
                      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nec sed lorem nunc varius rutrum eget dolor, quis. Nulla sit magna suscipit tellus malesuada in facilisis a.",style:
                      TextStyle(wordSpacing:2,color: Color(0xFF8E8E8E),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 12.0)),
                  SizedBox(height: 10),
                  Container(
                    child: Row(
                      children: [
          ...
          children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          ImageIcon(
                              AssetImage("assets/bed.png"), color: Colors.white, size: 25),
                          SizedBox(width: 5),
                          Text("1",style: TextStyle(fontSize: 15,color: Colors.white,fontFamily: 'Lato'))
                        ],
                      ),
                    ),
                    categoryBed("2"),categoryBed("3"),categoryBed("4"),
                  ],
                )
              ),
            SizedBox(height: 25),
            ...
            Padding(
              ...
              child: Row(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("GHJK Engineering College",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 18.0)),
                  Container(
                    height: 25,
                    width: 60,
                    decoration: BoxDecoration(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ImageIcon(
                      AssetImage("assets/location.png"), color: Colors.blueAccent, size: 18),
                  SizedBox(width: 5),
                  Text("Lorem ipsum dolor sit amet, consectetur ",style: TextStyle(wordSpacing:3.0,color: Color(0xFF4A4A4A),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 12.0)),
                ],
              ),
            ),
            Padding(
              ...
              child: Text(maxLines: 10,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Neque accumsan, scelerisque eget lectus ullamcorper a placerat. Porta cras at pretium varius purus cursus. Morbi justo commodo habitant morbi quis pharetra posuere mauris. Morbi sit risus, diam amet volutpat quis. Nisl pellentesque nec facilisis ultrices.",style:
                  TextStyle(wordSpacing:4,color: Color(0xFF969797),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 13.0)),
            ),
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Facilities",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w700,fontFamily: 'Lato',fontSize: 18.0)),
                  SizedBox(height: 15),
                  Row(
                    children: [
                      Container(
                      ...
                      SizedBox(width: 10),
                      Text("College in 400mtrs",style: TextStyle(wordSpacing:3.0,color: Color(0xFF4A4A4A),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 14.0)),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Text("Bathrooms : 2",style: TextStyle(wordSpacing:3.0,color: Color(0xFF4A4A4A),fontWeight: FontWeight.w600,fontFamily: 'Lato',fontSize: 14.0)),
                    ],
                  )
                ],
              ),
  ...
  Widget categoryBed(String number)
  {
    return Container(
      ...
      child: Row(
        children: [
          ImageIcon(
              AssetImage("assets/bed.png"), color: Color(0xFF0E3C6E), size: 25),
          SizedBox(width: 5),
          Text(number,style: TextStyle(fontSize: 15,color:Color(0xFF0E3C6E),fontFamily: 'Lato'))
        ],
      ),
    );
  }
