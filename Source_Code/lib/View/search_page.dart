...
import 'package:skygoaltask/View/college_list_page.dart';
...
class _SearchPageState extends State<SearchPage> {
                    ...
                    Row(
                      ...
                      children: [
                        Text("Find your own way",
                            style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontFamily: 'Lato',fontSize: 20.0)),
                        Icon(Icons.notifications_rounded,color: Colors.white,size: 25.0)
                      ],
                    ),
                    SizedBox(height: size.height*0.014),
                    Text("Search in 600 colleges around!",
                        style: TextStyle(color: Colors.white,fontFamily: 'Lato',fontSize: 14.0)),
                    ...
                    Row(
                      ...
                      children: [
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: "Search for colleges,schools and university",
                                    hintStyle: TextStyle(
                                      fontFamily: 'Lato',
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Icon(
                              Icons.mic,color: Color(0xFF0E3C6E),size: 22,
                            ),
                          )
                        )
                      ],
  ...
  Widget CardImage(BuildContext context,Size size,String url,String title,String content)
  {
    return Column(
      children: [
        GestureDetector(
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(title,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900,fontFamily: 'Lato',fontSize: 20.0)),
                      SizedBox(height: 10),
                      Text(content,
                          style: TextStyle(wordSpacing:3.0,color: Colors.white,fontWeight:FontWeight.w600,fontFamily: 'Lato',fontSize: 12.0)),
                    ],
                  ),
                ),
              ),
              ...
              Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("+126",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,fontFamily: 'Lato',fontSize: 11.0)),
                        Text("Colleges ",style: TextStyle(color: Color(0xFF848484),fontFamily: 'Lato',fontSize: 11.0)),
                      ],
                    ),
                  )
              )
            ...
            child: Column(
              children: <Widget>[
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text("Sort by",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w900,fontFamily: 'Lato',fontSize: 20.0)),
                    IconButton(
                      icon: Icon(
                        Icons.close_rounded,
